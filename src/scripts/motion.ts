...
if (!prefersReducedMotion) {
  ...
  // Las fuentes web (Unbounded/Jost) pueden cambiar la altura del documento después de que
  // ScrollTrigger calculó las posiciones de disparo; sin este refresco, una sección que quedó
  // "más abajo" de lo esperado nunca llega a animarse. `load` cubre también imágenes (el isotipo).
